...
func (m *SessionProviderMeta) validateName(formats strfmt.Registry) error {
...
func (m *SessionProviderMeta) validateStorageEngine(formats strfmt.Registry) error {
...
func (m *SessionProviderMeta) contextValidateName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SessionProviderMeta) contextValidateStorageEngine(ctx context.Context, formats strfmt.Registry) error {
