	...
	if m.ReturnOverrides != nil {
		if err := m.ReturnOverrides.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("return_overrides")
			}
			return err
		}
	}
...
func (m *MiniRequestObject) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateReturnOverrides(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *MiniRequestObject) contextValidateReturnOverrides(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.ReturnOverrides != nil {
		...
		if err := m.ReturnOverrides.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("return_overrides")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("return_overrides")
